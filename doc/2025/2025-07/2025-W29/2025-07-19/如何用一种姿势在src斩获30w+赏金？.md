> **原文链接**: https://mp.weixin.qq.com/s?__biz=MzIzMTIzNTM0MA==&mid=2247497908&idx=1&sn=d3b369b7be9623e74d5126ea31a92cf3
...
Clickhouse的SSRF根据目前实战的经验来看，主要是由URL函数和S3函数未禁用导致的，URL函数未禁用的情况居多，S3函数取决于业务是否需要  
提供 S3 特定的功能。  
