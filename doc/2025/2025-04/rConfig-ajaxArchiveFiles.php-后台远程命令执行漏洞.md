...
再请求 **http://xxx.xxx.xxx.xxx/test.txt**  
 验证漏洞  
  
![](https://mmbiz.qpic.cn/mmbiz_png/IePibcXn991NrgpuQXqSI4ycDcFQK0AR1SczBJamCIYdibF2rzhwL1FCJbtOkMs3iaopTTrWrRm6YDibV8IdubfThw/640?wx_fmt=png&from=appmsg "null")  
## 漏洞POC  
```
#!/usr/bin/python3
#-*- coding:utf-8 -*-
...
![](https://mmbiz.qpic.cn/mmbiz_png/IePibcXn991NrgpuQXqSI4ycDcFQK0AR1ARUFPo9DQFAI4Dy6mmXLia9CCVHmFmVUxibHYy6hIouwNbxm3LnDgShg/640?wx_fmt=png&from=appmsg "null")  
