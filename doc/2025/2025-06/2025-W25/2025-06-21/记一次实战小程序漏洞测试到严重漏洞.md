> **原文链接**: https://mp.weixin.qq.com/s?__biz=MzIwMzIyMjYzNA==&mid=2247519137&idx=1&sn=f34320074a73be0fb12aebfe9de74d94
...
，这个就是小程序的打包程序，需要对该文件进行解密，即可获取到小程序源码，解密脚本我使用的是
```
...
微信的历史版本可以在
```
https://github.com/tom-snow/wechat-windows-versions/tags
```
...
这里需要特别说明一下，在使用编译好的exe程序运行python程序时，可能会出现
```
...
在小程序分析过程中，我喜欢先抓包，浏览一下大概功能并看一下数据包的接口，大部分的小程序都是
```
host+api接口+uri接口
```
