...
原创 微步情报局  微步在线研究响应中心   2025-03-24 11:56  
...
微步情报局获取到 next.js middleware 权限绕过漏洞情报 CVE-2025-29927 (https://x.threatbook.com/v5/vul/XVE-2025-9720)。  
...
该漏洞利用难度较低，且技术细节已公开，建议受影响用户尽快修复。  
...
Next.js官方已发布漏洞公告，请尽快前往更新至不受影响版本：  
  
https://github.com/vercel/next.js/releases  
## 临时修复方案：  
##   
  
使用流量防护设备对请求头中包含 x-middleware-subrequest 字段的请求进行拦截。  
...
微步威胁感知平台TDP 已支持检测，  
检测ID  
：S3100159494，模型/规则高于20250324000000可检出。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/fFyp1gWjicMIe2Lzm5JLJDntMgOmtx0x29mPbCs3PMTnu491VoDhU9SYZyDGJbeTiaPZhdMXlzTicdYlicz8jwYE5g/640?wx_fmt=png&from=appmsg "")  
