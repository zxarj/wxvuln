...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3pB4Pwu3qr58ia5POK3owoNhZFdXqUA3f5kuEF3giaozeW58qPPz1V0sQ/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3jXtLVRDue6u8JorO7pEYbAbbO9zukL5n0gbhPENgaRFkyAamVicPCfg/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3gvia71ibgOzv1NbFU5yX9ibfeOt8dySQiauEXZE4vSfUWnsJ6AcwWCUSbw/640?wx_fmt=png&from=appmsg "")  
  
会自动弹出微信，登录后打开小程序即可hook成功  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3xEsXYib3WUZWT8EPM1TgTks2THvFUObkaMdmP0bmay2ACwiavmZqFUpw/640?wx_fmt=png&from=appmsg "")  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3nj19p7eRj5rAevzS82UBOJClBibGYs6pCKK5TwXQ2ia1womUK8bnQzqA/640?wx_fmt=png&from=appmsg "")  
## 小程序抓包  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3A8V38jC293kMlfYpug8qPcibO0Yh6QCtBCJu5h4w9jF2S3gia5N7y2Cg/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3eb06yGB3S2uNdUiaofeqmPVKm9vjicy5Lj05Hichy9L9WDw2VHcaibrNpw/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3QNSuU660uSbrusia3W0HEYnuWtynJQQ6fxz6jEjDs6kmQicFtoJdtkvw/640?wx_fmt=png&from=appmsg "")  
  
然后再burp中发送数据包进行测试，  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd357IcTOo6UNUyDgtiaBI6dHibQ1wTeUpI19IN9EpmBF3eUIKh3kawnAfA/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3RMpplHoTpMibLmCvO9gx6DpfFSfPmSjhKDtnwWlSK9JhhUJ9V9O81xQ/640?wx_fmt=png&from=appmsg "")  
  
分别打开这几个js，查找sign关键字  
定位到这个地方  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3An9icpxjDtsrGibdejZ6pd9uCJ8K701ibZrMicjEFogJukjJ4mzuA0ibOVw/640?wx_fmt=png&from=appmsg "")  
...
n就是requrl，var g = (new Date).getTime();  
就是时间戳  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3jdsqCDVbIdC3FXkFyCyv5Rnhb1nkkdGO9ZIribcG6UFvYVWcFMhfFVw/640?wx_fmt=png&from=appmsg "")  
  
还差一个t.globalData.key  
，全局搜索globalData  
。在32486行找到了key  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3hjruWqvwDro6BPFyyxwgI0TUR1ib1qyn5qtpacC5cnzHJEFmeiaJDy0g/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3T7eel7exRuyPrnmEGOn63hpMWf7nDBmrZIic290dF4fla0ciagcOYEsQ/640?wx_fmt=png&from=appmsg "")  
  
这样再往上去找函数调用的话不如动态调试来的方便，于是在32185行打上断点  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3icjIW7SFRQaZiaRyLGZ5rZL41tB4h52MOaBeQaQWeck3iaall2HUbHvFA/640?wx_fmt=png&from=appmsg "")  
  
找一个post功能的点，提交一下，便会停在断点上  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3ibatbibS88T0wic6b2CT3cGOyVrqLsiaFOxdP8dmfkdOQRXCZDqVbaDGIg/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3mN2kDicoLHqlkR5GnxhF28u8icjzcF8XibC2Awv2KFM8fypJSdwsegIsg/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3Uva9UEj0yNIN7osgnENt17zkSW1dzF13ia7qfIFJBkXLC5gnnvbkedg/640?wx_fmt=png&from=appmsg "")  
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd327kibKyr8FafhKCGibfUjCQEgeIzddJOryJrTWyEYgftkarOGqKmK9Rg/640?wx_fmt=png&from=appmsg "")  
  
token在js中没有相关算法，基本就可以确定是服务器返回的数据了，在burp的proxy history中搜索token字符串，看一下是哪个包返回的  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3hByXCA4bvTpzWP06h2Qbo2wQ8zaubbDHQzSyeWibBicqdib8ub3dKDYhg/640?wx_fmt=png&from=appmsg "")  
  
找到了接口，发送到repeater  
尝试修改userid，发现仍然会返回token，说明这里没有身份验证，可直接接管任意用户的聊天会话。写个python利用websocket库切入websocket会话，成功接管会话内容。  
  
![image.png](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF3jViceV36SG1zLZKXwAXdd3ja3LTPTtOIJAbWyqzHxdk4GmmrmDHYQfWeRFdxzhIAVAvU4zXsJAhw/640?wx_fmt=png&from=appmsg "")  
