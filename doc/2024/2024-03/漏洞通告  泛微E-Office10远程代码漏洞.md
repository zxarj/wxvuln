...
原创 微步情报局  微步在线研究响应中心   2024-03-27 14:01  
...
微步漏洞团队通过“X 漏洞奖励计划”获取到泛微E-Office10系统远程代码执行漏洞情报（https://x.threatbook.com/v5/vul/XVE-2023-19290）。攻击者可利用该漏洞  
在无需登陆的情况下获取服务器权限，利用难度极低，建议受影响的用户尽快修复  
。  
...
![](https://mmbiz.qpic.cn/mmbiz_png/fFyp1gWjicMJ6ptcOa9o0msXITwJcVwZnJVHuphhOVUk4PCuBvQlJs920CWM3Sn3qoSEUWcvzMtQbveedbb7Ugg/640?wx_fmt=png&from=appmsg "")  
...
- 微步威胁感知平台TDP已支持检测，规则ID为 S3100121730、S3100121732、S3100121734、S3100121736，模型/规则高于20230713000000可检出。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/fFyp1gWjicMJ6ptcOa9o0msXITwJcVwZnEeOO6IiacrhtbXkc56ySBs48PicIOCibrkWE5OVgs7RDzBLGJZBtR0ZDA/640?wx_fmt=png&from=appmsg "")  
  
- 微步安全情报网关OneSIG已支持防护，规则ID为 3100021377，默认规则即可检出。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/fFyp1gWjicMJ6ptcOa9o0msXITwJcVwZnVZpBsiaKMshxA8kE69bsRLXJ4uYIVdVPs4h4EBiaS0fib6McOtlKnL5dA/640?wx_fmt=png&from=appmsg "")  
  
  
**时间线**  
  
  
- 2023.06.17 微步"X漏洞奖励计划"获取该漏洞相关情报  
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/fFyp1gWjicMLC7CEC8tqZ3Q8syMZ8lwFDe5oyjKZ3ZiaGQMTkThBYwib3VJAx0kibCzUBSDUygqkHIMj1oJSnEcicxQ/640?wx_fmt=other&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1&tp=webp "")  
