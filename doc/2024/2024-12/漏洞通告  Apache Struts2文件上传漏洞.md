...
原创 微步情报局  微步在线研究响应中心   2024-12-12 04:35  
...
该漏洞可上传任意文件，从而远程执行任意代码  
。  
  
当前尚不掌握漏洞完整利用细节。但需要注意的是，此漏洞与   
CVE-2023-50164  
   
(https://x.threatbook.com/v5/vul/XVE-2023-35659) 类似，  
如果系统没有使用 FileUploadInterceptor 组件，则不受此漏洞影响  
。  
