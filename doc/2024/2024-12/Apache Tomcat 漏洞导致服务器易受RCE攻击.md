...
Ravie Lakshmanan  代码卫士   2024-12-25 10:11  
...
该漏洞的编号是CVE-2024-56337，是因位于同样产品中另外一个严重漏洞CVE-2024-50379（CVSS评分9.8）的缓解  
不完整引发的，后者于2024年12月17日修复。  
...
至 10.1.33 （在10.1.34或后续版本修复）  
  
- Apache Tomcat 9.0.0.M1   
至 9.0.97（在9.0.98或后续版本修复）  
