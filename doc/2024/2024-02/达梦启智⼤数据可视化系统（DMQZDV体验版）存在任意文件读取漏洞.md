...
    武汉达梦数据库股份有限公司达梦启智⼤数据可视化系统（DMQZDV体验版）存在任意文件读取漏洞，攻击者可利用该漏洞获取敏感信息。  
  
**影响版本：**  
- ```
```  
  
武汉达梦数据库股份有限公司 达梦启智⼤数据可视化系统（DMQZDV体验版））  
  
**修复方式：**  
- 厂商已提供漏洞修补方案，建议用户下载使用：https://www.dameng.com/list_103.html  
  
**相关链接：**  
- https://www.cnvd.org.cn/flaw/show/CNVD-2024-03150  
  
- http://www.loveli.com.cn:12530/one?hydkid=hydk-1706852087.6193504  
