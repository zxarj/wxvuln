...
近日，奇安信CERT监测到**泛微e-cology9 WorkflowServiceXml SQL注入漏洞(QVD-2024-26136)**在野利用行为，在默认配置下，未授权攻击者可利用该漏洞执行任意SQL语句，从而造成任意命令执行。**目前该漏洞PoC已在互联网上公开，**  
