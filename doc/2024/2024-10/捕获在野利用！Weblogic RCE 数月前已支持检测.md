...
原创 微步情报局  微步在线研究响应中心   2024-10-16 12:53  
...
该漏洞利用方式较为简单，攻击者在未授权条件下，利用 T3、IIOP协议反序列化，实现远程代码执行，获取服务器权限（无需出网）。  
该漏洞已被Oracle官方修复，CVE编号为CVE-2024-21216，  
建议用户尽快修复  
。  
