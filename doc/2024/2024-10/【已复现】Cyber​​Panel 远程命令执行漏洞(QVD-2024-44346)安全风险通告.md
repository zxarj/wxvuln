...
近日，奇安信CERT监测到官方修复**CyberPanel upgrademysqlstatus 远程命令执行漏洞(QVD-2024-44346)**，该漏洞源于upgrademysqlstatus接口未做身份验证和参数过滤，未授权的攻击者可以通过此接口执行任意命令获取服务器权限，从而造成数据泄露、服务器被接管等严重的后果。**目前该漏洞技术细节与EXP已在互联网上公开，**  
...
目前，奇安信威胁情报中心安全研究员已成功复现**CyberPanel upgrademysqlstatus 远程命令执行漏洞(QVD-2024-44346)安全风险通告******，截图如下：  
  
![](https://mmbiz.qpic.cn/mmbiz_png/EkibxOB3fs4ibSyP2CThAK1IGwovXztT5LWicWtUHGThaer7Zb54qG6qlf2fBtFRDnticoKzEgxzHU4HdPZQgghjwg/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/EkibxOB3fs4ibSyP2CThAK1IGwovXztT5LVW2Xiaicg0oz0DFzjIHsmoBohLUHEzbOe6CDQNdJG0QEZa6nJJKuoPIg/640?wx_fmt=png&from=appmsg "")  
  
**CyberPanel upgrademysqlstatus 远程命令执行漏洞(QVD-2024-44346)**关联的国内风险资产总数为241306个，关联IP总数为52719个。全球风险资产分布情况如下：  
  
![](https://mmbiz.qpic.cn/mmbiz_png/EkibxOB3fs4ibSyP2CThAK1IGwovXztT5LFGtQzQn6bn0E2IuYx4Obib3gb5EC7QPqcr4wibKDpb7f3RnJl3pHaN6g/640?wx_fmt=png&from=appmsg "")  
...
奇  
安信天眼新一代安全感知系统已经能够有效检测针对该漏洞的攻击，请将规则版本升级到3.0.1028.14538或以上版本。  
规则ID及规则名称：  
  
0x10021E9F，CyberPanel upgrademysqlstatus 远程命令执行漏洞(QVD-2024-44346)。奇安信天眼流量探针规则升级方法：系统配置->设备升级->规则升级，选择“网络升级”或“本地升级”。  
  
  
**奇安信网站应用安全云防护系统已更新防护特征库**  
  
奇安信网神网站应用安全云防护系统已全局更新所有云端防护节点的防护规则，支持对CyberPanel upgrademysqlstatus 远程命令执行漏洞(QVD-2024-44346)的防护。  
  
  
**奇安信网神网络数据传感器系统产品检测方案**  
  
奇安信网神网络数据传感器（NDS5000/7000/9000系列）产品，已具备该漏洞的检测能力。规则ID为：8094 ，建议用户尽快升级检测规则库至2410281530以上；  
  
  
**奇安信自动化渗透测试系统检测方案**  
  
奇安信自动化渗透测试系统已经能够有效检测针对该漏洞的攻击，请将插件版本和指纹版本升级到202411012600以上版本。规则名称：CyberPanel upgrademysqlstatus 远程命令执行漏洞。奇安信自动化渗透测试系统规则升级方法：系统管理->升级管理->插件升级（指纹升级），选择“网络升级”或“本地升级”。  
