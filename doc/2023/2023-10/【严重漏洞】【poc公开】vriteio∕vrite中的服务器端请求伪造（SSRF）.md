...
**漏洞名称**：vriteio/vrite中的服务器端请求伪造（SSRF）  
...
    0.3.0之前GitHub存储库vriteio/vrite中的服务器端请求伪造（SSRF）。
              
...
- https://nvd.nist.gov/vuln/detail/CVE-2023-5572  
...
Vrite是一个开源的协作空间，用于创建、管理和部署产品文档、技术博客和知识库。它旨在提供高质量、集成的用户和开发人员体验。  
  
  
图片版本更好保存哦~  
  
![](https://mmbiz.qpic.cn/mmbiz_png/h1AzajLJTBsEmV8Cr38R3PwvTTDjlMCv98ibGgbRLXWKlECWsV94iavIQTkuKgb85jOiajS7bzRwZmPibW7qJkhfDQ/640?wx_fmt=png "")  
