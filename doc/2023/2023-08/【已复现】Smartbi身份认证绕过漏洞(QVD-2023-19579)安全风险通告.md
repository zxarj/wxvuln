...
近日，奇安信CERT监测到Smartbi官方发布安全更新，修复了**SmartBI 身份认证绕过漏洞(QVD-2023-19579)：**  
由于Smartbi 登录代码逻辑漏洞(QVD-2023-15129)漏洞补丁可绕过，导致远程未授权攻击者仍可能通过windowUnloading参数绕过身份认证，进一步结合后台接口利用可实现远程代码执行。  
  
  
**鉴于该漏洞影响范围较大，且技术细节已公开，建议客户尽快做好自查及防护。**  
...
目前，奇安信CERT已成功复现**SmartBI 身份认证绕过漏洞**  
，截图如下：  
  
![](https://mmbiz.qpic.cn/mmbiz_png/EkibxOB3fs48rAu4bgZyiban3wq2UlA7DalGIEqoVEEuSsicnEzzTWciaiaQZTzpVv7Ny08C4urGZJa8oza6VeXic21A/640 "")  
...
目前官方已发布补丁更新，建议受影响用户安装 2023年8月22日 发布的补丁 ：  
...
奇安信网神网站应用安全云防护系统已全局更新所有云端防护节点的防护规则，支持对SmartBI 身份认证绕过漏洞(QVD-2023-19579)的防护。  
  
  
**奇安信天眼检测方案**  
  
奇安信天眼新一代安全感知系统已经能够有效检测针对该漏洞的攻击，请将规则版本升级到3.0.0824.14034或以上版本。规则ID及规则名称：0x1002183C，Smartbi 身份认证绕过漏洞(QVD-2023-19579)。奇安信天眼流量探针规则升级方法：系统配置->设备升级->规则升级，选择“网络升级”或“本地升级”。  
  
  
**奇安信网神网络数据传感器系统产品检测方案**  
  
奇安信网神网络数据传感器（NDS5000/7000/9000系列）产品，已具备该漏洞的检测能力。规则ID为：7800 ，建议用户尽快升级检测规则库至2308231814以上。  
...
![](https://mmbiz.qpic.cn/mmbiz_png/EkibxOB3fs48rAu4bgZyiban3wq2UlA7Da4mg46BiaWl03rRzmicAEtXuiaib8CUeaRwf2nqVenaqNbicbWOY6LvGITHA/640 "漏洞订阅上线.png")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/EkibxOB3fs48rAu4bgZyiban3wq2UlA7DaduUj3FgKbKqHLGtLmnFKFGQmqfECkfiba7KPxBU8Qzdkb1FwYibFc13Q/640 "CERT LOGO.png")  
