#  一个支付逻辑漏洞和一些tips   
 迪哥讲事   2023-11-18 21:49  
  
一个支付逻辑漏洞  
## 正文  
  
某目标为xxx.com,其网站上面有价格为999元的订阅优惠，这里使用burp suite,在点击支付的时候拦截该支付请求,  
  
将价格从999改为1，发现成功了  
  
![](https://mmbiz.qpic.cn/mmbiz_png/YmmVSe19Qj67XIT6KWFTsZoHTqDTgoV7SkdrK1nhymM7XFG4yQicoW9Ajuc0icCuUFGnicNUUAyDPibgWxvzTJY7TA/640?wx_fmt=png&from=appmsg "")  
## 几个高频率的xss的payload  
```
